...
import com.example.nmitscanner.databinding.EachPdfItemBinding

class PdfFilesAdapter(private val listner: PdfClickListener) :
        ...
        RecyclerView.ViewHolder(binding.root){
            ...
            init {
                binding.root.setOnClickListener{
                    listner.onPdfClicked(getItem(adapterPosition))
